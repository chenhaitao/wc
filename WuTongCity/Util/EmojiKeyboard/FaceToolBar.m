...
-(id)initWithFrame:(CGRect)frame superView:(UIView *)superView text:(NSString *)_text{
    self = [super initWithFrame:frame];
    if (self) {
        // Initialization code
        //初始化为NO
        ...
        //可以自适应高度的文本输入框
        textView = [[UIExpandingTextView alloc] initWithFrame:CGRectMake(10, 5, 300, 36)];
...
//        faceButton.frame = CGRectMake(toolBar.bounds.size.width - 40.0f,toolBar.bounds.size.height-38.0f,buttonWh,buttonWh);
...
//        [toolBar addSubview:sendButton];
        ...
        [self.theSuperView addGestureRecognizer:gestureRecognizer];
